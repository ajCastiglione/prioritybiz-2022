...
<body <?php body_class(); ?>>
	...
	<div id="container">
				...
				<div class="header__split large-wrapper">
					<div class="header__item">
						<a href="<?php echo home_url(); ?>" rel="nofollow">
							<img src="<?= $logo ?>" alt="<?= bloginfo('name') ?>" id="logo" class="h1">
						</a>
					</div>
		...
		<?php if (get_field('show_banner', 'options')) : $banner = get_field('banner_fields', 'options') ?>
			<div class="banner">
				<div class="banner__content"><?= $banner['message'] ?></div>
			</div>
		<?php endif; ?>